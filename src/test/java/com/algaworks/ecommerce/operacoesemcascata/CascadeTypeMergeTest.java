...
//	@Test
	public void atualizarProdutoComCategoria() {
		...
		Assert.assertTrue(produtoVerificacao.getCategorias().get(0).getNome().equals("Informática"));
    ...
    public void atualizarPedidoComItens() {
        ...
        pedido.setListaItemPedido(Arrays.asList(itemPedido)); // CascadeType.MERGE
    ...
    public void atualizarItemPedidoComPedido() {
        ...
        pedido.setListaItemPedido(Arrays.asList(itemPedido));
