...
public class ExportarDDL {
    ...
    public static void main(String[] args) {
        ...
        propriedades.put("javax.persistence.schema-generation.scripts.create-target", "C:/temp/sql/script-criacao-exportado.sql");
        propriedades.put("javax.persistence.schema-generation.scripts.drop-target", "C:/temp/sql/script-remocao-exportado.sql");
