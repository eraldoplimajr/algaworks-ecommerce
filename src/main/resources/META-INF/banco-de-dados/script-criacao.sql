...
create table produto (id integer not null auto_increment, data_criacao datetime(6) not null, data_ultima_atualizacao datetime(6), descricao longtext, imagem longblob, nome varchar(100) not null, preco decimal(19,2), primary key (id)) engine=InnoDB;
